...
import com.mohamad394.list_todo.adapters.AllListsAdapter;
import com.mohamad394.list_todo.adapters.AllTasksAdapter;
...
import static com.mohamad394.list_todo.Lists.nameOfList;
...
public class Daily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteAdapter.setOnItemClickListener(new AllListsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(  int position ) {
                ...
                Intent intent = new Intent(Daily.this,ViewTask.class);
    ...
    public void backtask(View view) {
        startActivity(new Intent(Daily.this,Lists.class));
        finish();
    }

    public void OnClickCreateNewtask(View view) {
        Intent intent=new Intent(Daily.this,AddTask.class);
        startActivity(intent);
        finish();
    }
    ...
    public void delete(View view) {
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(Daily.this)
//set icon
...
//set positive button
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent intent=new Intent(Daily.this,Lists.class);
                        startActivity(intent);
                        finish();
